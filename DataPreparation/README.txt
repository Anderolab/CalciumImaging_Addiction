...
Main Folder: Name of the animal
        Subfolders: All sessions belonging to that animal.
                ...
                Inside Each Subfolder:
                        ...
                        Within each recording folder:
                                The ms file and a CSV file named TimeStamps.csv.
